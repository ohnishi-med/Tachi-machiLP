...
const Home: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-slate-900">
            {/* ヒーローセクション */}
            <header className="relative overflow-hidden bg-slate-50 pb-20 lg:pb-32">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    {/* Navigation Header */}
                    <nav className="relative p-6 flex justify-between items-center z-50">
                        <div className="font-bold text-xl text-slate-900">タチマチ</div>
                        <div>
                            <Link to="/guide" className="text-slate-600 hover:text-teal-600 font-medium transition-colors">
                                使い方を見る
                            </Link>
                        </div>
                    </nav>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 mt-10">
                        ...
                        <div className="lg:w-1/2 text-center lg:text-left z-20">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 mb-8">
                                ...
                                <Link
                                    to="/guide"
                                    className="px-8 py-4 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 text-lg font-bold rounded-lg shadow-sm hover:shadow-md transition-all cursor-pointer flex items-center justify-center"
                                >
                                    使い方ガイド
                                </Link>
                            </div>
